...
Pyramid::Pyramid() {
   vertex[0][0] = -1;  vertex[0][1] = -1;  vertex[0][2] = 0;
	...
	// faceColor
			...
			faceColor[0][0] = 0.5, faceColor[0][1] = 0.2; faceColor[0][2] = 0.8;
			faceColor[1][0] = 0.0, faceColor[1][1] = 0.5; faceColor[1][2] = 1.0;
			faceColor[2][0] = 0.2, faceColor[2][1] = 0.8; faceColor[2][2] = 0.5;
			faceColor[3][0] = 0.5, faceColor[3][1] = 0.9; faceColor[3][2] = 0.1;
